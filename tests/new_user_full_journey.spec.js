...
import { paymentDetails as customerDetails } from "../data/paymentDetails.js";

test("New user full endt-end test journey", async ({ page }) => {
  ...
  await paymentPage.fillPaymentDetails(customerDetails);
});
